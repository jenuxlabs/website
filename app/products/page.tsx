export default function Products() {
  return <>
    ...
    <section className="product-index">
      ...
      <a className="product-index-card nas" href="/products/phonenas/"><img src="/phonenas/icon.png" alt="" /><div><span className="status">Closed testing</span><h2>PhoneNAS</h2><p>Turn selected Android folders into SMB network shares with users and permissions.</p><strong>Product details and Mac helper →</strong></div><figure><img src="/phonenas/home-093.png" alt="PhoneNAS home screen" /></figure></a>
      <a className="product-index-card desk" href="/products/phonedesk/"><span className="app-monogram">PD</span><div><span className="status">In development</span><h2>PhoneDesk</h2><p>A larger, desktop-shaped Android workspace for a display, keyboard and mouse.</p><strong>See the development direction →</strong></div><div className="desk-window" aria-hidden="true"><span>PhoneDesk</span><i /></div></a>
    </section>
  </>;
}
