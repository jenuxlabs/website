...
export default function PhoneDesk() {
  return <>
    <section className="product-spotlight desk-spotlight"><div><span className="status">In development</span><div className="product-lockup"><span className="app-monogram">PD</span><span>PhoneDesk</span></div><h1>Give your phone room to think.</h1><p className="lede">PhoneDesk is an Android workspace direction built around a larger display, keyboard and mouse.</p><div className="actions"><a className="button" href="mailto:hello@jenuxlabs.com?subject=PhoneDesk">Contact Jenux Labs</a><a href="/products/">See all apps →</a></div></div><div className="desk-stage" aria-hidden="true"><div className="desk-screen"><span className="desk-bar">PhoneDesk</span><div className="desk-panels"><i /><i /><i /></div></div><span className="desk-base" /></div></section>
